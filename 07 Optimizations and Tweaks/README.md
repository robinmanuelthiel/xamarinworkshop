...
> **Hint:** Be careful! If we had defined the `Icon` the standard way like `<ContentPage Icon="Calendar.png">`, all platforms had to hold the image files inside their projects.
